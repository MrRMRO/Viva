...
<head>
    ...
    <title>Customer Sign In | SpiritReserve</title>
...
<main class="relative flex-1 flex items-center justify-center pt-16">
    <!-- Background Layer -->
    <div class="absolute inset-0 z-0">
        <div class="w-full h-full bg-center bg-no-repeat bg-cover"
             data-alt="High quality background image of whiskey glass with amber liquid"
    ...
    <div class="relative z-10 w-full max-w-[480px] px-6 py-12">
        <div class="glass-effect rounded-xl p-8 shadow-2xl flex flex-col">
            ...
            <div class="text-center mb-8">
                <h1 class="text-white tracking-light text-[32px] font-bold leading-tight pb-2 font-display">Welcome
                    Back</h1>
                <p class="text-white/70 text-base font-normal leading-normal">Access your curated spirits and exclusive
                    offers.</p>
            </div>
            <!-- Form Section -->
            <form class="flex flex-col gap-5">
                ...
                <div class="flex flex-col gap-1.5">
                    <div class="flex justify-between items-center px-1">
                        <label class="text-white text-sm font-medium leading-normal">Password</label>
                ...
                <div class="flex items-center gap-2 px-1">
                    <input class="w-4 h-4 rounded border-[#543b3d] bg-[#271c1c] text-primary focus:ring-primary focus:ring-offset-background-dark"
                           id="remember" type="checkbox"/>
                    <label class="text-white/80 text-sm cursor-pointer" for="remember">Remember me for 30 days</label>
                </div>
            ...
            <p class="text-center text-white/60 text-sm mt-8">
                ...
                <a class="text-primary font-semibold hover:underline ml-1" href="#">Sign Up</a>
            </p>
        </div>
    </div>
</main>
